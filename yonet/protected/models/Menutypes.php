 ...
 *
 * The followings are the available columns in table 'menutypes':
 * @property integer $id
...
class Menutypes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('menutype, title, description', 'required'),
			array('menutype, title', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, menutype, title, description', 'safe', 'on'=>'search'),
		);
	}
