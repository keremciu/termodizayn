...
class ProductModel extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('product, name, price, content, ordering', 'required'),
	...
	public function relations()
	{
		...
		return array(
			...
			'modelproduct' => array(self::BELONGS_TO, 'Product', 'product'),
			'modelattrib' => array(self::BELONGS_TO, 'ModelAttribMap', 'model_id'),
		);
	}

	public function getFullName()
	{
		return $this->ordering. ' ' .$this->name;
	}
	...
	public function search()
	{
		...
		$criteria->with = array('modelproduct');
			...
			'sort'=>array(
		        ...
		        'attributes'=>array(
		            'product_search'=>array(
		                'asc'=>'modelproduct.title',
		                'desc'=>'modelproduct.title DESC',
		            ),
