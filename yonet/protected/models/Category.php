...
class Category extends CActiveRecord
{
	...
	{
		return array(
			array('title, type, is_published', 'required'),
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
			'sort'=>array(
				'defaultOrder'=>'t.parent ASC, t.ordering DESC',
		        'attributes'=>array(
		            'parentname'=>array(
		                'asc'=>'t.parent ASC, t.title',
		                'desc'=>'t.parent DESC, t.title DESC',
		            ),
