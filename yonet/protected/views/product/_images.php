...
<div class="form-section">
	...
	<div class="form-section_content">
		...
		<div id="product-image-upload" action="<?php echo Yii::app()->createUrl("product/fileupload"); ?>" method="POST" enctype="multipart/form-data"  data-trigger-input="Product_image" >
			<!-- File Upload -->
			<?php
				// get model image
	...
	<div class="form-section">
		...
		<div class="form-section_content">
			...
			<div id="product-gallery-upload" action="<?php echo Yii::app()->createUrl("product/fileupload"); ?>" method="POST" enctype="multipart/form-data">
				<!-- File Upload -->
	...
	<div class="form-section">
		...
		<div class="form-section_content">
			<div id="sortable-document-upload" action="<?php echo Yii::app()->createUrl("product/fileupload"); ?>" method="POST" enctype="multipart/form-data">
				<!-- File Upload -->
				<div class="files-container extra-files">
					<?php
							$files = Pimages::model()->findAll(array('condition' => 'type = "file" AND pid = :pid','params'=>array(':pid'=>$model->id)));
	...
	<div class="form-section">
		...
		<div class="form-section_content">
			...
			<div id="sortable-video-link" class="sortable">
				<?php
					$videos = Pimages::model()->findAll(array('condition' => 'type = "video" AND pid = :pid','params'=>array(':pid'=>$model->id)));
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-1">
									<div class="sortable-button delete-image" data-id="<?php echo $video->id; ?>" data-url="<?php echo Yii::app()->createUrl("product/extraitemdelete"); ?>">
										<svg class="td-icon td-icon-cancel"><use xlink:href="#icon-cancel"></use></svg>
									</div>
								</div>
							</div>
