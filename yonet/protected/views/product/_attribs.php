<?php
    $attribs = ProductAttrib::model()->findAll(array('condition'=>'container = "product"','order'=>'ordering'));
?>
<div class="form-section">
    <h1 class="form-section_title">ÇALIŞMA KOŞULLARI</h1>
        ...
        <div id="sortable-tecnical-info" class="sortable sortable--list-show">
            <?php 
                ...
                if (!$model->isNewRecord) {
                    ...
                    $savedattribs = ProductAttribMap::model()->findAll(array('condition'=>'product_id='.$model->id));
                ...
                <div class="row old-specification">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="sortable-button sortable-button_remove savedattrdelete">
                            <a href="<?php echo Yii::app()->createUrl('product/attrdelete'); ?>" rel="<?php echo $attrib->id; ?>" target="_blank">
            ...
            <div class="aspecification form-group bordered">
                <div class="row new-specification">
                    ...
                    <div class="col-md-2">
                        <input type="checkbox" name="show-on-list-{{key}}">
                    </div>
                    <div class="col-md-2">
