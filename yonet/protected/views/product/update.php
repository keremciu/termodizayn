...
<div class="main-area col-md-12 main-content main-content--full">
	<?php
		$this->renderPartial('_form', array('model'=>$model,'form'=>$form,'categories'=>$categories));
echo "</div></div>";
...
<div class="form-actions">
	<?php $this->widget('booster.widgets.TbButton', array(
		...
		'label'=> '<svg class="td-icon td-icon-done"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-done"></use></svg> Urunu Kaydet'
	)); ?>
</div>
</div>
<?php
